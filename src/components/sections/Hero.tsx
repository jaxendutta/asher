...
export function Hero() {
  return (
    <div className="relative z-10 max-w-5xl mx-auto px-8 sm:px-16 lg:px-24 text-center space-y-4 bg-gradient-to-r from-[#F4EBD0]/70 to-[#B8D4BE]/60 rounded-3xl p-8 border-2 border-[#B8D4BE]">
